...
public:
	...
	static void BlurByWidth(BMPFILE* originalBmp, BMPFILE* bluredBmp, int startWidth, int endWidth, std::ofstream* fout, clock_t startTime, int threadNumber, LogBuffer* logbuffer, int radius = 5);
